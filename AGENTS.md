...
- CRITICAL: Update `docs/HANDOFF.md` after each agent task when documentation updates are allowed.
...
- Updates `docs/REVIEW.md` when needed.
- Writes the next copy-paste-ready prompt in `docs/HANDOFF.md` when follow-up work is needed.
